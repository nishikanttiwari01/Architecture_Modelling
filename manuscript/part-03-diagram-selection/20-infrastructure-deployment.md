...
- `FIG-20-01`: Choosing the Right Infrastructure and Deployment View, specification
  prepared; source and export deferred pending author approval.
...
The planned `FIG-20-01` will give a compact visual route through these choices once its
specification is author-approved. This table remains the detailed selection aid.
