...
- Scope: Cover trust boundaries, authentication flows, authorisation models, threat modelling, STRIDE, attack trees, security data-flow diagrams and control mapping.
- Subsections:
  - Chapter purpose
  - Reader outcomes
  - Prerequisites and dependencies
