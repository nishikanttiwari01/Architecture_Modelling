...
Show ADR-26-01 and requirements as intent; responsibility design; API and event contracts; physical data design; security controls; deployment, configuration and observability; repository evidence; verification evidence; and feedback to intent. Label refinement, implementation, verification and feedback relationships.

## Layout

Use a portrait, top-to-bottom layout targeting 700 to 800 pixels wide. Keep detailed-design artefacts in separate labelled boxes. Repository and verification evidence must be visually distinct.

## Scope and exclusions

Use Online Store checkout. Exclude code listings, complete payloads, vendor-specific manifests and claims of formal notation conformance.
