...
PlantUML mind-map decision guide using simple shapes and labelled branches. The author
authorised source and export production on 2026-07-11.
...
- Author sign-off is recorded before source creation.
- PlantUML source renders to SVG.
- Register paths are updated after rendering.
- Chapter 20 has a meaningful caption and accessibility text.
- Output is readable at intended page width and passes visual inspection.
