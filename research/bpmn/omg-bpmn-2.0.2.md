...
BPMN 2.0.2 is recorded as the official specification version for Chapter 6 research. Recheck the OMG specification page during final review before publication.

## Copyright or reuse notes

Do not copy official diagrams, tables or long passages from the specification. Use short source keys and original explanatory diagrams.
