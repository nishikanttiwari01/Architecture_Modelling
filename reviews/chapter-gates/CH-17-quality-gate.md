...
-  The chapter distinguishes user experience, business process, software runtime
  collaboration
and lifecycle state.
...
-  The chapter includes review checklist, key takeaways, practical exercise and
  suggested
answer.
...
-  `[OMG-UML]`: reused for UML use case, sequence, activity and state machine
  terminology.
...
-  PNG preview: not required by repository convention because SVG is the
...
-  Consistency review:
  `reviews/consistency-review/chapter-17-review-2026-07-07.md`.
...
-  Chapter 17 research, draft, diagrams, review and sources verified must be 100
  percent.
...
-  Final book-page layout inspection of FIG-17-01 remains pending under the
  general diagram
`Review` convention.
