...
- The chapter distinguishes user experience, business process, software runtime
  collaboration and lifecycle state.
...
- PNG preview: not required by repository convention because SVG is the publication
  output and Chapter 15 and Chapter 16 selection guides also use SVG only.
...
- Final book-page layout inspection of FIG-17-01 remains pending under the general
  diagram `Review` convention.
