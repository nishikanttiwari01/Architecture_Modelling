...
- [x] Required sections and beginner outcomes are complete.
- [x] Chapter 22 view selection is distinguished from Chapter 30 migration governance.
- [x] Current, transition and target states, waves, patterns, data, cutover, fallback, retirement, readiness, governance, benefits and feedback are covered.
- [x] The lifecycle and roadmap are not presented as mandatory or guaranteed.
