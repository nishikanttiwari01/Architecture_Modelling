...
| 35 | Modelling Bank Value Streams with BIAN | Ready for Author Approval | 100 | 100 | 100 | 100 | 100 | Author review; `FIG-35-01` at Review; accept or revise `DEC-043` |
...
Chapter 35, **Modelling Bank Value Streams with BIAN**, is `Ready for Author Approval`. It defines a full-bank value-stream portfolio and detailed customer-acquisition cross-map while keeping stakeholder value, capabilities, processes, journeys and candidate BIAN responsibilities distinct. `FIG-35-01` remains at `Review`, not `Approved`. `DEC-043` remains `Proposed`. Four review passes and the quality gate completed on 2026-07-12.

Last updated: 2026-07-12 (Chapter 35 completed)
