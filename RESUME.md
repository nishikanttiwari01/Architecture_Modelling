...
- Chapter 4 status: `Ready for Author Approval`
...
Chapter 6, **BPMN: Business Process Model and Notation**, after Chapter 4 author review or revision. Do not begin Chapter 6 until instructed.

## Next exact action

Review Chapter 4. If the author requests revisions, keep the scope to Chapter 4. Do not mark any diagrams `Approved` until the author explicitly approves them.
