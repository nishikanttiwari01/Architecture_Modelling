...
Chapter 7, **ArchiMate**, has been revised for author review using ArchiMate 4 as the current source basis. Chapter 6 is author-approved, and Chapter 6 diagrams remain at `Review`.

The Chapter 7 revision added the ArchiMate 4 source note, preserved the ArchiMate 3.2 note as historical, strengthened notation-reading and model-reuse guidance, corrected actor versus role, application realisation and technology support explanations, and updated the six Chapter 7 diagram specifications for author review.

No Chapter 7 PlantUML, Archi or Draw.io source files have been created.

## Current Git commit

- Current pushed commit before this Chapter 7 ArchiMate 4 revision: `0fa447a`
...
- Diagram status for Chapter 7 figures `FIG-07-01` through `FIG-07-06`: `Planned`

## Pending non-critical issues

- Chapter 1 awaits author review.
- Chapter 7 awaits author review of revised prose and the six diagram specifications.
- Chapter 7 diagrams must not be created until the author approves or revises the specifications.
...
Do not begin Chapter 8 until Chapter 7 prose, source basis and diagram specifications have been reviewed and the author directs the next task.

## Next exact action

Review Chapter 7, **ArchiMate**, and approve or revise `FIG-07-01` through `FIG-07-06` specifications before diagram source creation.
